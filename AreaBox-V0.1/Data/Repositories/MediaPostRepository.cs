...
namespace AreaBox_V0._1.Data.Repositories
{
	public class MediaPostRepository : Repository<MediaPosts>, IMediaPostRepository
	{
		...
		public async Task<IEnumerable<MediaPostViewModel>> FindAndFilter(Expression<Func<MediaPosts, bool>> match, string[] includes = null, int? cityId = null, int? categoryId = null, int? countryId = null, int? skip = null, int? take = null)
		{
			IQueryable<MediaPosts> query = _db.MediaPosts.AsQueryable();
			...
			var viewModels = _mapper.Map<IEnumerable<MediaPostViewModel>>(entities);
			return viewModels;
		}
	}
}
